...
public class OTP {
	...
	public OTP(String key) throws Exception {
		this.setKey(key);
	}
	...
	public static String encrypt(String text, String key) throws Exception {
		...
		if(text.length() != key.length()) {
			throw new Exception("Plaintext and Key are of unequal length");
		}
	...
	public static String decrypt(String text, String key) throws Exception {
		...
		if(text.length() != key.length()) {
			throw new Exception("Ciphertext and Key are of unequal length");
		}
